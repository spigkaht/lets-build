class HousesController < ApplicationController
  ...
  private
    ...
    def house_params
      params.require(:house).permit(:name, :builder, :area_total, :area_house, :min_block_width, :width_house, :length_house, :storeys, :bedrooms, :bathrooms, :living_areas, :study_areas, :price_base)
    end
end
